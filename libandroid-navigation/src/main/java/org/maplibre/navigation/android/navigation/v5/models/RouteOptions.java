...
public abstract class RouteOptions extends DirectionsJsonObject {
   ...
   * Must be used in conjunction with {@link Builder#steps(Boolean)}.
   *
  ...
  public abstract static class Builder {
     ...
     * entering and exiting the roundabout. With roundabout_exits=true, this maneuver becomes two
     * instructions, one for entering the roundabout and one for exiting it. Must be used in
     * conjunction with {@link Builder#steps(Boolean)}
     *
     ...
     * Can be {@link DirectionsCriteria#IMPERIAL} (default) or {@link DirectionsCriteria#METRIC}.
     * Must be used in conjunction with {@link Builder#steps(Boolean)}=true and
     * {@link Builder#voiceInstructions(Boolean)}=true.
     *
     ...
     * Must be used in conjunction with {@link Builder#steps(Boolean)} = true.
     *
     ...
     * Must be used with {@link Builder#steps(Boolean)} = true.
